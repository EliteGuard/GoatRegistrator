...
public class LocalVisitProtocolSearchResultAdapter extends BaseAdapter implements Filterable {
    private List<LocalVisitProtocol> listItems;
    private List<LocalVisitProtocol> listOrigItems;
    private LayoutInflater mLayoutInflater;
    private VisitProtocolFilter filterVisitProtocol;
    private List<LocalVisitProtocol> mSelectedItems;
    //private DatabaseHelper dbHelper;

    private List<VisitActivity> listActivities;

    public LocalVisitProtocolSearchResultAdapter(Context context, List<LocalVisitProtocol> list) {

        listItems = list;
        listOrigItems = list;
        mSelectedItems = new ArrayList<LocalVisitProtocol>();
        /*dbHelper = dbh;
        try {
    ...
    public LocalVisitProtocol getItem(int position) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        LocalVisitProtocol vp = listItems.get(position);
        if (vp != null) {
    ...
    public List<LocalVisitProtocol> getSelected() {
    ...
    private class VisitProtocolFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() == 0) {
                ...
                List<LocalVisitProtocol> nVisitProtocolList = new ArrayList<LocalVisitProtocol>();
                for (LocalVisitProtocol vp : listItems) {
        ...
        protected void publishResults(CharSequence constraint,FilterResults results) {
            ...
            if (results.count == 0 && constraint.length()==0)
                ...
                listItems = (List<LocalVisitProtocol>) results.values;
                notifyDataSetChanged();
            }
