...
public class CityCursorAdapter extends CursorAdapter {
    ...
    public CityCursorAdapter(Context context, Cursor c, int flags, DatabaseHelper databaseHelper) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        String keyword = cursor.getString(cursor.getColumnIndex("name"));
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence constraint) {
        ...
        try {
            ...
            cqb.selectColumns("_id", "name", "area", "municipality").groupByRaw("name")
                    .where().like("name", filter+"%")
                    .and()
                    .like("area", mArea)
                    .and()
                    .like("municipality", mMunicipality);
