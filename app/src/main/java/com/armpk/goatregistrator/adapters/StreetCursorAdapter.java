...
public class StreetCursorAdapter extends CursorAdapter {
    ...
    public StreetCursorAdapter(Context context, Cursor c, int flags, DatabaseHelper databaseHelper) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        String keyword = cursor.getString(cursor.getColumnIndex("street"));
    ...
    public CharSequence convertToString(Cursor cursor) {
        ...
        String value = "";
        value = cursor.getString(cursor.getColumnIndex("street"));
        return value;
    }
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence constraint) {
        ...
        try {
            ...
            aqb.selectColumns("_id", "street").groupByRaw("street").where().like("street", "%"+filter+"%");
