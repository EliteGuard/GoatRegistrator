package com.armpk.goatregistrator.services;
...
public class BluetoothService {
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        Message msg = mHandler.obtainMessage(Globals.MESSAGE_DEVICE_NAME);
            ...
            try {
                if (secure) {
                    ...
                    tmp = mAdapter.listenUsingInsecureRfcommWithServiceRecord(
                            NAME_INSECURE, Globals.UUID_SECURE);
                }
            } catch (IOException e) {
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (mState == STATE_CONNECTED) {
                try {
                    ...
                    mHandler.obtainMessage(Globals.MESSAGE_READ, bytes, -1, buffer)
                            .sendToTarget();
                } catch (IOException e) {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(Globals.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
